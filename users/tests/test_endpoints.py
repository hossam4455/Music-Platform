...
class TestUser():
    ...
    def test_get_authenticate_put(self,auth_client):
         ...
         response = auth_client().put('/users/1/',{'username':"hossam",'password1':"123456",'password2':"123456",'email':"h@h.com"},format="json") 
    ...
    def test_get_authenticate_patch(self,auth_client):
         ...
         response = auth_client().patch('/users/1/',{'username':"hossam1",'password':"123456"},format="json")
